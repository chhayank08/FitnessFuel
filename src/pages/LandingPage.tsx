          ...
          <div className="bg-dark-500 rounded-lg shadow-xl w-full max-w-md relative overflow-hidden">
            <div className="p-6">
              ...
              <div className="my-4 flex items-center">
                <div className="flex-1 border-t border-dark-300"></div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-medium py-3 px-4 rounded-md transition duration-200 disabled:opacity-70"
              >
